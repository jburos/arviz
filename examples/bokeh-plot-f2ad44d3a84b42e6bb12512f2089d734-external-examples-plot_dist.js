(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("a0d071bc-7500-4457-a100-1ba0dd53178e");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a0d071bc-7500-4457-a100-1ba0dd53178e' but no matching script tag was found.")
        }
