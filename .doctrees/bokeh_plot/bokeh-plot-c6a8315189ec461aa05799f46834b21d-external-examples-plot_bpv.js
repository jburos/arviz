(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("55c40610-647f-4157-a03f-abf5bb072d63");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '55c40610-647f-4157-a03f-abf5bb072d63' but no matching script tag was found.")
        }
