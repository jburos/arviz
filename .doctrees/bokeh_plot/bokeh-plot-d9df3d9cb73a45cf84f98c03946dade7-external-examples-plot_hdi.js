(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("d0bd0d77-9243-41cd-bde3-488a35ab3732");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd0bd0d77-9243-41cd-bde3-488a35ab3732' but no matching script tag was found.")
        }
